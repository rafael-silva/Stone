...
private let expectedfacts: [ResponsePayload.FactPayload] =
...
private let expectedResponse: ResponsePayload = ResponsePayload(total: 308, result: expectedfacts)
...
class FactListWorkerTest: QuickSpec {
    ...
    override func spec() {
        ...
        describe("FactListWorker") {
            ...
            describe("when 'getFacts' was called") {
                ...
                context("and the request was completed with a valid response") {
                    ...
                    it("then should return a response") {
                        ...
                        let disposable = sut_worker.api.getFacts(term: "Car")
                            .asObservable()
                            .subscribe(observer)
                        ...
                        expect(newResponse?.result.count).to(equal(expectedResponse.result.count))
